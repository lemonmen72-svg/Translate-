...
enum class SourceLang(
     ...
     * файлы доступны. Для китайского прямая модель zh→ru предпочтительнее
     * пивота через английский — перевод через посредник теряет смысл, ровно за
     * это ТЗ и критиковало универсальные модели. Но если прямой модели в релизе
     * нет, пивот всё равно лучше, чем ничего: два прохода по компактной модели
     * дешевле одного прохода NLLB-600M.
     */
